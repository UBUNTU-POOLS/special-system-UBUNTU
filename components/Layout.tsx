  ...
  const [theme, setTheme] = useState<'light' | 'dark'>(() => {
    if (typeof window !== 'undefined') {
      try {
        ...
        console.warn("Storage access blocked by browser policy. Defaulting to system preference.");
      }
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <Link to="/prospectus" className="text-[9px] font-black uppercase tracking-widest text-[#D4AF37] hover:opacity-80 transition-all border border-[#D4AF37]/30 px-3 py-1 rounded-full">Prospectus 2025</Link>
